...
//        InformEditStatus: "InfEditSta",
         ...
         * 取消会议
         */
        ConferenceCancel: "ConferenceCancel",

        getConferenceMsgType: function () {
            if (!this._conferenceMsgType)
                this._conferenceMsgType = [this.ConferenceInvite, this.ConferenceStart, this.ConferenceUpdate, this.ConferenceEnd, this.ConferenceAcceptInvite,
                    this.ConferenceAcceptStart, this.ConferenceRefuseStart, this.ConferenceCancel];
