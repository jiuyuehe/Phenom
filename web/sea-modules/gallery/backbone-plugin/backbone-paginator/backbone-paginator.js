define("gallery/backbone-plugin/backbone-paginator/backbone-paginator",["underscore","backbone"],function(require, exports, module) {
...
Backbone.Paginator = (function ( Backbone, _, $ ) {
  ...
  Paginator.clientPager = Backbone.Collection.extend({
    ...
    sync: function ( method, model, options ) {
      ...
      queryOptions = _.extend(queryOptions, {
        data: JSON.stringify(queryAttributes),
        processData: false,
  ...
  Paginator.requestPager = Backbone.Collection.extend({
    ...
    sync: function ( method, model, options ) {
      ...
      if( options.data ){
        options.data =  JSON.stringify(_.extend(queryAttributes,options.data));// decodeURIComponent($.param(_.extend(queryAttributes,options.data)));
      }else{
        options.data = JSON.stringify(queryAttributes);
      }

      queryOptions = _.extend(queryOptions, {
        data: JSON.stringify(queryAttributes),//decodeURIComponent($.param(queryAttributes)),
        processData: false,
        url: _.result(queryOptions, 'url')
      }, options);
